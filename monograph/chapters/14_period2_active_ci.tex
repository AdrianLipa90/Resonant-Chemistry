...
\begin{equation}
R^k(ab;cd)=\iint
u_a(r_1)u_c(r_1)u_b(r_2)u_d(r_2)
\frac{r_<^k}{r_>^{k+1}}\,dr_1dr_2,
\qquad k=0,2,
\end{equation}
combined with the same angular Wigner algebra used by the equivalent-shell solver.  Diagonalization is exact inside this finite active space.  Consequently, configurations analogous to $2p^{n-2}3p^2$ are not inserted as hand-written corrections; they arise as determinants in the common CI basis.
